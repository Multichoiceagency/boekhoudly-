  ...
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <select class="px-3 py-2 border border-surface-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500">
          <option>2026</option>
          <option>2025</option>
        </select>
        <select class="px-3 py-2 border border-surface-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="report in reports" :key="report.title" class="bg-white rounded-xl border border-surface-200 shadow-sm p-6 hover:shadow-md transition-shadow">
        ...
        <button class="mt-4 text-sm font-medium text-primary-600 hover:text-primary-700 flex items-center gap-1">
          Bekijk rapport
